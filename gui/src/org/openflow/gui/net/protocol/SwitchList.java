 ...
 */
public abstract class SwitchList extends OFGMessage {
    public final long[] dpids;
    
    public SwitchList(OFGMessageType t, final long[] dpids) {
        this(t, 0, dpids);
    }
    
    public SwitchList(OFGMessageType t, int xid, final long[] dpids) {
        super(t, xid);
        this.dpids = dpids;
    }
    
    public SwitchList(final int len, final OFGMessageType t, final int xid, final DataInput in) throws IOException {
        super(t, xid);
