...
LAVI_MESSAGES.append(Disconnect)
...
LAVI_MESSAGES.append(PollStart)
...
LAVI_MESSAGES.append(SwitchesRequest)
...
LAVI_MESSAGES.append(SwitchesAdd)
...
LAVI_MESSAGES.append(SwitchesDel)
...
LAVI_MESSAGES.append(LinksRequest)
...
class LinksList(LAVIMessage):
    ...
    def __str__(self):
        return LAVIMessage.__str__(self) + ' links=%s' % str(self.links_to_string())
...
LAVI_MESSAGES.append(SwitchesSubscribe)
...
LAVI_MESSAGES.append(LinksSubscribe)

LAVI_PROTOCOL = LTProtocol(LAVI_MESSAGES, 'H', 'B')
